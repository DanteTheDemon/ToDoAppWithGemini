...
from ..routers.auth import get_current__user
...
user_dependency = Annotated[dict, Depends(get_current__user)]
...
async def render_todo_page(request: Request, db: db_dependency):
    try:
       user = await get_current__user(request.cookies.get('access_token'))
       if user is None:
...
def create_todo_with_gemini(todo_string: str):
    ...
    response = llm.invoke(
        [
            HumanMessage(content="I will provide you a todo item to add my to do list. What ı want you to do is to create a longer and more comprehensive description of that todo item, my next message will be my todo: "),
...
if __name__ == '__main__':
    print(create_todo_with_gemini("learn controlling"))